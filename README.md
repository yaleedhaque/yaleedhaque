<h1 align="center">
  ...
  <br>
  <em>Local-first systems · Offline multiplayer · Android apps · AI desktop automation</em>
</h1>
...
I build local-first software that just works offline: ultra-low-latency virtual gamepads, AI-driven desktop automation, wireless Bluetooth HID remotes, and offline Android apps. I write production C#/.NET and Kotlin, experiment with low-level networking and Bluetooth protocols, and love pushing the limits of what can run without the cloud.
